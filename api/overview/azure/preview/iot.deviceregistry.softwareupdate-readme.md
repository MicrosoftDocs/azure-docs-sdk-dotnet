---
title: Azure Software Update for Device Registry client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.IoT.DeviceRegistry.SoftwareUpdate, deviceregistry
ms.date: 09/12/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: deviceregistry
---
# Azure Software Update for Device Registry client library for .NET - version 1.0.0-alpha.20260912.1 
