---
title: Azure Provisioning Machine Learning client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.Provisioning.MachineLearning, machinelearningservices
ms.date: 09/04/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: machinelearningservices
---
# Azure Provisioning Machine Learning client library for .NET - version 1.0.0-alpha.20260903.1 
