---
title: Azure Provisioning Container Registry Tasks client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.Provisioning.ContainerRegistry.Tasks, containerregistry
ms.date: 09/04/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: containerregistry
---
# Azure Provisioning Container Registry Tasks client library for .NET - version 1.0.0-alpha.20260904.1 
